document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Reset after delay (replace with real submission logic as needed)
      setTimeout(function () {
        contactForm.reset();
        fields.forEach(function (field) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9ea5f652-8d16-4b52-823f-4fe49ee93a2d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9ea5f652-8d16-4b52-823f-4fe49ee93a2d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9ea5f652-8d16-4b52-823f-4fe49ee93a2d';
